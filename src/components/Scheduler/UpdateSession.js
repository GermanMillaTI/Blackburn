...
import { auth, realtimeDb, updateValue } from '../../firebase/config';
                    ...
                    <div>
                        ...
                        <table>
                            <tbody className="participant-table">
                                ...
                                <tr>
                                    <td className="participant-table-left">State</td>
                                    <td className="participant-table-right">{Constants['usStates'][participantInfo['residenceState']]}</td>
                                </tr>
                                                ...
                                                <td className="participant-table-center" colSpan="2">
                                                    {
                                                        ...
                                                        Object.keys(database['client'][participantId]).map(tag => {
                                                            const formatted = TimeSlotFormat(updateSession).slice(0, 10)
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="participant-table-right">
                                        ...
                                        >
                                            {Object.values(Constants['sessionStatuses']).map((s, i) => {
                                ...
                                <tr>
                                    ...
                                    <td className="participant-table-right">
                                        ...
                                        >
                                            {Object.values(Constants['participantStatuses']).map((s, i) => (
